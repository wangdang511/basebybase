...
/**
 * Colorscheme for the Hide Identical Residues option. Same color scheme as <CODE>IdentityColorScheme</CODE>
 * colors the background black for identical bases, with the first sequence as the reference
 *
 * @author Kaegan Mandryk
 */
public class IdenticalResiduesColorScheme implements StrandedColorScheme {
    //~ Instance fields ////////////////////////////////////////////////////////
     ...
     */
    public IdenticalResiduesColorScheme() {
    ...
    public Color getBackground(
        ...
        // if the char is a gap, or there aren't enough sequences, colour white
        ...
        // if the char doesn't match reference (top) sequence, colour black
        if (!(seq.equals(m_seqs[0])) && (Character.toUpperCase(seq.charAt(index)) == Character.toUpperCase(m_seqs[0].charAt(index)))) {
